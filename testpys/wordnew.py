...
class DirectDocxParser:
    """直接解析docx的XML结构，避免依赖python-docx"""
...
if __name__ == '__main__':
    doc = DirectDocxParser(r"D:\code\SmartSheetPY\input\sign_for_QingziClass\环境与生态学院-环境工程与科学-陈展202417021024\环境与生态学院-环境工程与科学-陈展202417021024.docx")
    print(doc.parse_tables_from_xml())
    print(doc.parse_paragraphs_from_xml())
